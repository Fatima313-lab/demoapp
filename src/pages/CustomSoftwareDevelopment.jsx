...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Custom Software Development Services', item: PAGE_URL },
  ],
};
...
const CustomSoftwareDevelopment = () => {
  ...
  const { ref: industriesRef, inView: industriesInView } = useInView({ triggerOnce: true, threshold: 0.1  });
  ...
  return (
    <>
      ...
      <Helmet>
        {/* ── Primary ───────────────────────────────── */}
        <title>Custom Software Development Services in Pakistan | QllmSoft</title>
        <meta
          name="description"
        ...
        <meta property="og:title"        content="Custom Software Development Services in Pakistan | QllmSoft" />
        <meta property="og:description"  content="Pakistan's trusted custom software development company building secure, scalable web, mobile, desktop, and AI-powered software for global clients." />
        <meta property="og:image"        content={OG_IMAGE} />
        <meta property="og:image:width"  content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt"    content="QllmSoft — Custom Software Development Company Pakistan" />
        <meta property="og:locale"       content="en_US" />

        {/* ── Twitter Card ──────────────────────────── */}
        <meta name="twitter:card"        content="summary_large_image" />
        <meta name="twitter:title"       content="Custom Software Development Services in Pakistan | QllmSoft" />
        <meta name="twitter:description" content="Pakistan's trusted custom software development company building web, mobile, desktop, and AI software for global clients." />
        <meta name="twitter:image"       content={OG_IMAGE} />
        <meta name="twitter:image:alt"   content="QllmSoft — Custom Software Development Company Pakistan" />
      ...
      <main id="main-content" className="csd-page" role="main">
        ...
        <nav className="csd-breadcrumb" aria-label="Breadcrumb navigation">
          <div className="container">
            ...
            >
              ...
              <span aria-hidden="true" className="csd-breadcrumb__sep">›</span>
              <li itemScope itemProp="itemListElement" itemType="https://schema.org/ListItem">
                <span itemProp="name" aria-current="page">Custom Software Development Services</span>
        ...
        <header className="csd-hero">
          <div className="container">
            <p className="csd-hero__eyebrow">Pakistan's Trusted Software Development Partner</p>

            {/* ✅ ONE H1 */}
            <h1 className="csd-hero__title">
              Custom Software Development<br />Services in Pakistan
            </h1>

            <p className="csd-hero__sub">
              We build secure, scalable web, mobile, desktop, and AI-powered software tailored to your
              exact business workflows — serving clients across the US, UK, Europe, and the Gulf from
              our base in Pakistan.
            </p>
            ...
            <div className="csd-hero__stats" aria-label="QllmSoft key statistics">
              {[
            ...
            <div className="csd-hero__pills" aria-label="Core service areas">
              {[
                { icon: '🌐', title: 'Web Application Development',   desc: 'ASP.NET Core, React, Angular — from SaaS platforms to enterprise dashboards.' },
                { icon: '📱', title: 'Mobile App Development',        desc: 'iOS & Android apps with Flutter and React Native.' },
                { icon: '🤖', title: 'AI-Powered Software Solutions', desc: 'ML.NET and OpenAI-powered intelligent integrations.' },
              ].map(p => (
            ...
            <div className="csd-hero__tags" aria-label="Technologies used">
              {['.NET Core','React','Angular','Azure','SQL Server','OpenAI API'].map(t => (
          ...
          <div className="container">
            ...
            <div className="about-content">
              ...
              <article className={`about-text animate__animated ${aboutInView ? 'animate__fadeInLeft' : ''}`}>
                ...
                <p>
                  QllmSoft is a Pakistan-based <strong>custom software development company</strong> that
                  helps small-to-medium businesses and enterprises around the world build technology that
                  actually works for them — not against them. We don't sell templates or off-the-shelf
                  patches. Every line of code we write is grounded in your specific business challenges.
                </p>
                <p>
                  Our team of senior .NET developers, mobile engineers, UI/UX designers, and QA specialists
                  brings deep technical skill together with genuine business understanding. Whether you are
                  launching a first digital product, replacing a legacy system, or scaling a complex
                  enterprise application, we treat your project with the same seriousness we would our own.
                </p>
                <p>
                  We serve clients in the <strong>United States, United Kingdom, UAE, Saudi Arabia, and
                  Europe</strong>, offering the cost advantage of{' '}
                  <Link to="/outsource-software-development-to-pakistan">
                    offshore software development in Pakistan
                  </Link>{' '}
                  without sacrificing communication, quality, or delivery timelines.
                </p>
                <div className="csd-badges" aria-label="Certifications and process standards">
                  {['GDPR & HIPAA Compliant','ISO-Aligned Processes','Agile Delivery','Global Clients'].map(b => (
                    <span key={b} className="csd-badge">✓ {b}</span>
                  ))}
                </div>
              </article>
              ...
              >
                {[
                  { num: '98%', label: 'Client Satisfaction Rate — measured across all completed projects' },
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="services-heading">End-to-End Software Development Services in Pakistan</h2>
              <p>
                From the first line of code to post-launch support, we handle every phase of software
                development with precision, transparency, and real ownership.
              </p>
            </div>
            ...
            <div className="csd-services__grid">
              {[
                ...
                >
                  <span className="csd-service-card__icon" aria-hidden="true">{s.icon}</span>
                  ...
                  <Link to={s.link} className="csd-service-card__link" aria-label={s.aria}>Learn More →</Link>
                </article>
              ))}
            </div>
          </div>
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="industries-heading">Industry-Specific Software Solutions</h2>
              <p>
                We understand that every industry operates under different rules, pressures, and
                expectations. Our software is built around those realities — not around generic feature lists.
              </p>
            </div>
            <div className="csd-industries__grid">
              {[
                { icon: '🏦', title: 'Finance & Banking Software',      desc: 'Secure payment gateways, custom CRMs, risk management dashboards, and regulatory-compliant financial tools built to the strict standards of the banking sector.' },
                { icon: '🏥', title: 'Healthcare Management Systems',   desc: 'HIPAA-compliant patient portals, electronic health records (EHR), telehealth platforms, and appointment scheduling systems that improve patient care and staff efficiency.' },
                { icon: '🎓', title: 'Education & eLearning Platforms', desc: 'Custom education software for schools, universities, and corporate training programs — including LMS systems, progress tracking, and interactive course tools.' },
                { icon: '🏘️', title: 'Real Estate CRM & Management',  desc: 'Property listing platforms, client-focused CRMs, virtual tour integrations, and operations management tools that modernize how real estate businesses serve their customers.' },
                { icon: '🚚', title: 'Logistics & Supply Chain',        desc: 'Inventory tracking, fleet management, route optimization, and end-to-end supply chain visibility tools built for logistics providers who need speed and control in one place.' },
                { icon: '☁️', title: 'SaaS Product Development',       desc: 'Scalable multi-tenant SaaS platforms with subscription billing, user role management, analytics dashboards, and seamless API integrations — engineered to grow from Day 1.' },
              ].map((ind, i) => (
                <article
                  key={i}
                ...
                >
                  <span className="csd-industry-card__icon" aria-hidden="true">{ind.icon}</span>
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="process-heading">Our Custom Software Development Process</h2>
              <p>
                We follow a structured, business-driven methodology that keeps your project on track from
                the first conversation to the final delivery — and beyond.
              </p>
            </div>
            ...
            <div className="csd-process__layout">
              <ol className="csd-process__steps" aria-label="Software development process steps">
                {[
                  { n:'1', title:'Discovery & Concept Validation', desc:'We begin by understanding your business, goals, and users. We validate the concept and identify the right technical approach before a single line of code is written.' },
                  { n:'2', title:'Project Planning & Scoping',     desc:'We define timelines, milestones, technology stack, team allocation, and cost structure — giving you full transparency from the start.' },
                  { n:'3', title:'Requirements Analysis',          desc:'Our business analysts document detailed functional and non-functional requirements, ensuring development decisions are grounded in real business need.' },
                  { n:'4', title:'UI/UX Design',                   desc:'We design intuitive, accessible interfaces that users actually enjoy — validated through wireframes and interactive prototypes before development begins.' },
                  { n:'5', title:'Agile Development & Sprints',    desc:'Development happens in two-week sprints with regular demos and feedback loops — keeping you informed and in control throughout the build.' },
                  { n:'6', title:'Testing, QA & Integration',      desc:'Every module goes through rigorous automated and manual QA — unit testing, integration testing, performance benchmarking, and security audits.' },
                  { n:'7', title:'Deployment & Ongoing Support',   desc:'We handle deployment to your preferred environment — cloud or on-premise — and provide long-term maintenance, updates, and performance monitoring.' },
                ].map((step, i) => (
                  <li
                    key={i}
              ...
              >
                ...
                <div className="csd-process__cta-box">
                  ...
                  <p>
                    Share your idea with us and get a structured development roadmap — free of charge,
                    no obligation.
                  </p>
                  <Link
                    to="/contact"
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="why-heading">Why Choose Our Software Development Team in Pakistan?</h2>
              <p>
                There are many software companies in Pakistan. Here is what makes working with QllmSoft
                different — and why clients come back for their next project.
              </p>
            </div>
            <div className="why-grid">
              {[
                { title:'Competitive Offshore Rates',  desc:'Get world-class development quality at a fraction of US or UK agency prices — without cutting corners on technology, testing, or communication.' },
                { title:'Transparent Communication',   desc:'You get direct access to your development team, not a middleman. Regular video calls, written updates, and a dedicated Slack channel keep you in the loop daily.' },
                { title:'Security-First Architecture', desc:'We build with role-based access control, SSL encryption, secure APIs, and compliance standards (GDPR, HIPAA, PCI-DSS) baked into every layer — not added as an afterthought.' },
                { title:'Built to Scale With You',     desc:'Our architectures are designed for growth. Adding users, features, or new modules to your software will not require rebuilding from scratch — ever.' },
              ].map((w, i) => (
                <article
                  key={i}
        ...
        <section className="section csd-tech" aria-labelledby="tech-heading">
          <div className="container">
            ...
            <div className="section-title">
              ...
              <p>
                We select technology based on what is right for your project's longevity, performance,
                and maintainability — not what happens to be trendy.
              </p>
            </div>
            <ul className="csd-tech__grid" aria-label="Programming languages and frameworks used by QllmSoft">
              {[
                'ASP.NET Core','React.js','Angular','SQL Server',
                'React Native','Flutter','Microsoft Azure','ML.NET',
                'OpenAI API','Docker','Git & DevOps','Entity Framework',
              ].map(t => (
          ...
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="testimonials-heading">
                What Our Global Clients Say About Our Software Development Services
              </h2>
              <p>
                Independent, verified reviews from real clients on Freelancer — from the UK, USA,
        ...
        <section className="section csd-case" aria-labelledby="case-heading">
          <div className="container">
            ...
            <div className="section-title">
              ...
              <p>
                Off-the-shelf software is built for everyone, which means it is perfect for no one.
                Here is why businesses that invest in custom development consistently outperform those
                that do not.
              </p>
            </div>
            <div className="csd-case__grid">
              {[
                { icon:'⚙️', title:'Built Around Your Workflows',  desc:'Custom software adapts to how your team actually works, not the reverse. The result is higher adoption, fewer workarounds, and measurably better operational efficiency from day one.' },
                { icon:'📈', title:'Scales Without Limits',         desc:'As your business grows, custom software grows with it. Add users, new modules, or integrations without hitting subscription walls, licensing fees, or performance ceilings.' },
                { icon:'🔒', title:'Better Security & Compliance',  desc:'You control the code, the data, and the infrastructure. That means stronger security posture, full compliance with industry regulations, and no dependency on third-party vendor decisions.' },
                { icon:'🏆', title:'Genuine Competitive Advantage', desc:"Your competitors are using the same off-the-shelf tools. Custom software gives you capabilities they cannot replicate, creating real differentiation in how you serve your customers." },
                { icon:'💰', title:'Lower Long-Term Cost',          desc:'Monthly SaaS fees, per-seat pricing, and vendor lock-in add up fast. Custom software, properly built, pays for itself through automation, efficiency gains, and eliminated tool redundancy.' },
                { icon:'🤝', title:'A Partner, Not Just a Vendor', desc:"We stay invested in your product's success beyond launch. Our team provides strategic input, not just technical execution — because we understand that the software we build affects your business outcomes directly." },
              ].map((c, i) => (
                <article key={i} className="csd-case-card">
                  <span className="csd-case-card__icon" aria-hidden="true">{c.icon}</span>
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="faq-heading">
                Frequently Asked Questions About Custom Software Development in Pakistan
              </h2>
              <p>
                Can't find your answer here? Reach out to us directly — we respond within a few hours
                on business days.
              </p>
            </div>
        ...
        <section className="section csd-final-cta" aria-labelledby="cta-heading">
          <div className="container">
            <div className="csd-final-cta__content">
              <h2 id="cta-heading">Ready to Build Something That Actually Works?</h2>
              <p>
                Whether you have a fully scoped project or just an idea, let's talk. We'll help you
                define a clear roadmap, realistic timeline, and a budget that makes sense — before
                any commitment.
              </p>
