  ...
  return (
    <>
      ...
      <main id="main-content" className="api-page" role="main">
          ...
          <div className="container api-hero__inner">
            ...
            <div className="api-hero__content">
              ...
              <h1 className="api-hero__title">
                Expert API Development Services<br />
                for <span className="api-hero__accent">Web, Mobile &amp; Cloud</span>
              </h1>

              <p className="api-hero__sub">
                QllmSoft engineers secure, scalable, and high-performance APIs — REST, GraphQL &amp;
                SOAP — that seamlessly connect your applications, platforms, and databases into one
                powerful integrated ecosystem.
              </p>
            ...
            <aside className="api-hero__cards" aria-label="API types we build">
              {[
                { label: 'REST API',    icon: '⚡', desc: 'Lightweight, stateless, universally compatible'    },
                { label: 'GraphQL',     icon: '🔮', desc: 'Query exactly what you need — nothing more'         },
                { label: 'SOAP / XML',  icon: '🏛️', desc: 'Enterprise-grade & legacy system compatible'       },
                { label: 'Webhooks',    icon: '🔔', desc: 'Real-time event-driven automation pipelines'        },
                { label: 'Microservices', icon: '🧩', desc: 'Decoupled, independently deployable services'    },
                { label: 'Integrations', icon: '🔗', desc: 'CRM, ERP, payment gateways, logistics & more'     },
              ].map(c => (
                <div key={c.label} className="api-hero__card">
                  <span className="api-hero__card-icon" aria-hidden="true">{c.icon}</span>
                  <div>
          ...
          <div className="container">
            <div className="api-about__layout">
              ...
              <div className={`api-about__text animate__animated ${aboutInView ? 'animate__fadeInLeft' : ''}`}>
                ...
                <h2 id="about-heading">
                  Pakistan's Premier Custom API Development Company
                </h2>
                <p>
                  Every smooth digital experience — from mobile apps syncing data to the cloud to
                  payment gateways processing transactions instantly — runs on the power of APIs.
                  QllmSoft builds the bridges that make your systems work together flawlessly.
                </p>
                <p>
                  We offer dedicated <strong>API development services</strong> for{' '}
                  <Link to="/website-development-services">web applications</Link>,{' '}
                  <Link to="/mobile-app-development">mobile applications</Link>, and cloud-based
                  software — ensuring seamless integration and optimal performance. Whether you
                  require secure RESTful APIs, efficient GraphQL endpoints, or need to modernize
                  outdated legacy APIs, our experienced developers build scalable, high-performance
                  interfaces that deliver measurable business value.
                </p>
                <p>
                  We also specialize in <strong>API integration services</strong> that seamlessly
                  connect your software with third-party platforms including payment gateways, CRMs,
                  ERPs, and logistics providers — serving businesses across Pakistan and globally.
                </p>
              ...
              >
                <img
                  src="https://qllmsoft.com/images/api-development-service-page.webp"
          ...
          <div className="container">
            <div className="api-explainer__layout">
              ...
              <div className="api-explainer__text">
                <p className="section-eyebrow" style={{ textAlign:'left' }}>The Basics</p>
                <h2 id="explainer-heading">What Are API Development Services?</h2>
                <p>
                  API development services involve creating and integrating{' '}
                  <strong>Application Programming Interfaces (APIs)</strong> — the bridges that allow
                  your software systems to communicate effortlessly. Think of APIs as universal
                  translators: they ensure smooth data exchange, seamless integrations, and improved
                  application performance across your entire digital ecosystem.
                </p>
                <p>
                  Our expert developers design <strong>secure, scalable, and high-performance
                  APIs</strong> for web, mobile, and cloud platforms. From modernizing legacy systems
                  to enabling real-time data sharing across Pakistan's fastest-growing businesses,
                  we make your digital infrastructure run smarter.
                </p>
                <p>
                  Whether you're a Lahore-based startup building an MVP or a Karachi enterprise
                  modernizing legacy infrastructure, QllmSoft delivers{' '}
                  <strong>API solutions engineered for Pakistan's digital economy</strong>.
                </p>
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="bestpract-heading">API Development Best Practices We Follow</h2>
              <p>
                Every API we build is engineered with these core principles — ensuring your
                investment is scalable, secure, and future-proof.
              </p>
            </div>
            <div className="api-practices__grid">
              {[
                ...
                },
                {
                  ...
                  desc: 'Well-documented APIs reduce onboarding time by 60%. We deliver comprehensive Swagger/OpenAPI docs so your team can integrate and maintain without friction.',
                },
                {
                  num: '03',
                  icon: '🔐',
                  title: 'Secure Authentication (OAuth 2.0 / JWT)',
                  desc: 'We implement modern security standards from day one — OAuth 2.0, JWT tokens, rate limiting, and HTTPS — protecting your users and data at every layer.',
                },
                {
                  num: '04',
                  icon: '🤝',
                  title: 'Free Consultation Before Development',
                ...
                >
                  <div className="api-practice-card__header">
                    ...
                    <span className="api-practice-card__icon" aria-hidden="true">{p.icon}</span>
                  </div>
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              ...
              <p>
                Professionally built APIs are one of the highest-ROI investments in your digital
            ...
            <div className="api-invest__grid">
              {[
                {
                  icon: '💰',
                  title: 'Tap Into New Revenue Streams',
                  desc: 'Well-crafted APIs let you open up core features for external use — unlocking monetization through partner access, third-party integrations, and digital ecosystems that generate recurring revenue.',
                  stat: '↑ Revenue',
                },
                {
                  icon: '🔗',
                ...
                >
                  <div className="api-invest-card__top">
                    <span className="api-invest-card__icon" aria-hidden="true">{v.icon}</span>
        ...
        >
          <div className="container">
            <p className="section-eyebrow">Your Decision Guide</p>
            <div className="section-title">
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="edge-heading">Why Choose QllmSoft for API Development in Pakistan?</h2>
              <p>
              ...
              {[
                {
                  num: '01',
                  icon: '⚡',
                  title: '10+ Years Building REST, GraphQL & SOAP APIs',
                  desc: 'Our developers bring deep, hands-on experience with modern protocols and legacy enterprise APIs. Fewer surprises, faster delivery, and interfaces built to last.',
                  highlight: false,
                },
                {
                  num: '02',
                ...
                },
                {
                  ...
                  desc: 'Top-Rated Plus on Upwork. 5-star reviews on Freelancer. Serving clients across the UK, USA, UAE, and Pakistan — our reputation is backed by independent third-party platforms.',
                  highlight: false,
                },
                {
                  num: '06',
                ...
                >
                  <div className="api-edge-card__header">
                    ...
                    <span className="api-edge-card__icon" aria-hidden="true">{e.icon}</span>
                  </div>
        ...
        >
          <div className="container">
            ...
            <div className="section-title">
              <h2 id="services-heading">Our API Development Services</h2>
              <p>
                From custom RESTful APIs to complex enterprise integrations — every solution is
                engineered for performance, security, and long-term scalability.
              </p>
            </div>
              ...
              {[
                ...
                >
                  <div className="api-service-card__top">
                    ...
                    <span className="api-service-card__icon" aria-hidden="true">{s.icon}</span>
                  </div>
