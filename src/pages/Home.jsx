          ...
          <div className="container">
            <div className="about-content">
              ...
              >
                ...
                <p>
                  Our development team delivers more than code — we deliver
                  business outcomes. Every project is scoped, priced, and
                  structured before development begins, so you always know what
                  you are getting, when you are getting it, and exactly what it
                  costs. No hidden charges, no scope creep, no surprises.
                </p>
                <p>
      ...
      <div className="outsourcing-image">
        ...
        >
          <div className="container">
            ...
            <p>
              As a specialised ASP.NET Core and custom software development
              company based in Pakistan, QllmSoft has delivered over 100
              production-grade digital solutions across healthcare, finance,
              education, logistics, eCommerce, and SaaS sectors. Our team of
              certified .NET developers, React engineers, mobile app developers,
              and solution architects brings both deep technical knowledge and
              genuine business domain understanding to every engagement.
            </p>
